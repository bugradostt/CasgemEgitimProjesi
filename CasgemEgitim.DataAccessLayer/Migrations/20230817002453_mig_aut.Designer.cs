...
namespace CasgemEgitim.DataAccessLayer.Migrations
{
    ...
    [Migration("20230817002453_mig_aut")]
    partial class mig_aut
    {
            ...
            modelBuilder.Entity("CasgemEgitim.EntityLayer.Concrete.Message", b =>
                {
                    ...
                    b.HasOne("CasgemEgitim.EntityLayer.Concrete.Teacher", null)
                        .WithMany("ReceivedMessages")
                        .HasForeignKey("TeachertId");

                    b.HasOne("CasgemEgitim.EntityLayer.Concrete.Teacher", null)
                        .WithMany("SentMessages")
                        .HasForeignKey("TeachertId1");
                });
